...
<html>
  ...
  <body>
    <div id="replace-me" class="container">
      <div class="jumbotron">
        <h1>Degust</h1>
        <p><a href='http://drpowell.github.io/degust2/'>Degust</a> is preparing your data...  prepare for degustation...</p>
        <img src='http://drpowell.github.io/degust2/dist/latest/images/front-loader.gif'>
      </div>
    </div>
    ...
    #print columns
    settings = ["html_version: '2.0'",
                "asset_base: 'http://drpowell.github.io/degust2/dist/latest/'",
                "csv_data: data", 
